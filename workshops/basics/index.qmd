...
<ul>
  <li>Python beginners with little to no experience</li>
  <li>Enthusiasts</li>
  <li>Future coders</li>
</ul>

<ul>
  <li>If you are following the full <b>Getting Started with</b> series:
    <ul>
        <li>Cracking the Code: A Beginner’s Guide to Computing Concepts</li>
        <li><code>Getting Started with Python - Basics</code></li>
