...
::::::: {.person}
![](../../assets/people/ashley.jpg)
<div class="name"><strong>Ashley Pearson</strong></div>
<div class="role">University Library Specialist</div>
:::::::
:::::::
...
:::::: {.nonincremental style="font-size: 1.2rem; line-height: 1.15;"}
...
- Build Your First Public Portfolio with GitHub: AI, Version Control, and IDE Basics
- Data Science Special Topics: Parallelization with Python
- Data Science Special Topics: Working with Local LLMS
- Data Science Special Topics: Agentic Coding with Claude
- Introduction to Command Line Interfaces (CLIs) with bash
  ...
  <li>If you are following the full intro series:
    <ul>
      <ol>
        ...
        <li>Getting Started with Python - Basics</li>
